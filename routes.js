...
module.exports = new Router()
 .destination(
    'legacy', // displayed in the destination dropdown in the traffic splitting section of your environment configuration in the Layer0 Developer Console
    new Router()
      // additional routing rules for the legacy experience go here
      .fallback(({ proxy }) => proxy('legacy')),
  )
  .destination(
    'new', // displayed in the destination dropdown in the traffic splitting section of your environment configuration in the Layer0 Developer Console
    new Router()
